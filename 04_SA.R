...
cat("Saved: sa_30_run_results.csv, sa_convergence_summary.csv, sa_coverage_summary.csv, sa_acceptance_summary.csv, sa_temperature_summary.csv and sa_summary_table.csv.\n")