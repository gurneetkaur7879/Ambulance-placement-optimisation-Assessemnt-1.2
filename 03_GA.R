...
#write_csv(best_ga_by_mode, "ga_best_solution_by_mode.csv")
...
#write_csv(ga_summary_display, "ga_summary_display.csv")
...
#write_csv(ga_history, "ga_convergence_history_all_runs.csv")
...
#write_csv(ga_coverage_history, "ga_coverage_history_all_runs.csv")
